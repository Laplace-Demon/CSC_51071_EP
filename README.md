Assignments realized for course CSC_51071_EP - Distributed data structures, with a soptlight on blockchains (Structures des données distribuées, avec un focus sur les blockchains)
